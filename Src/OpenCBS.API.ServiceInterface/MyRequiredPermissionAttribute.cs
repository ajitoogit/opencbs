...
namespace OpenCBS.API.ServiceInterface
{
    ...
    public class MyRequiredPermissionAttribute : MyAuthenticateAttribute
    {
        public List<string> RequiredPermissions { get; set; }

        public MyRequiredPermissionAttribute(ApplyTo applyTo, params string[] permissions)
        {
        ...
        public MyRequiredPermissionAttribute(params string[] permissions)
